...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'psychomot', 'user' => 'root', 'password' => 'jecode4laloupe', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array(($this->targetDirs[3].'/src/AppBundle/Resources/config/doctrine') => 'AppBundle\\Entity', ($this->targetDirs[3].'/src/PsychoBundle/Resources/config/doctrine') => 'PsychoBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'AppBundle\\Entity');
        $b->addDriver($a, 'PsychoBundle\\Entity');
        ...
        $c->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'PsychoBundle' => 'PsychoBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4b364db92adc04d8d8bbe6fb513f5e98fb75dfa8c8a0ffd3618b15e432e784f6');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $n->setOptions(array('always_use_default_target_path' => true, 'default_target_path' => '/psycho/1/edit', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PsychoBundle/Resources/views'), 'Psycho');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('f6b014ddb575a9683e69b8ad13148419d25412a5');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PsychoBundle' => 'PsychoBundle\\PsychoBundle',
            ...
            'secret' => 'f6b014ddb575a9683e69b8ad13148419d25412a5',
            'locale' => 'en',
            ...
            'kernel.secret' => 'f6b014ddb575a9683e69b8ad13148419d25412a5',
